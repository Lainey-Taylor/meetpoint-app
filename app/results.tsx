    ...
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.body} showsVerticalScrollIndicator={false}>
        <View style={[styles.diagnosis, relaxed && styles.diagnosisRelaxed]}>
          <View style={styles.diagnosisIcon}><AppIcon name={relaxed ? 'exclamationmark.triangle.fill' : 'checkmark.seal.fill'} size={20} color={colors.brand} /></View>
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 }, body: { padding: 16, paddingBottom: 28, gap: 12 }, diagnosis: { backgroundColor: '#fff', borderRadius: 14, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 11 }, diagnosisRelaxed: { backgroundColor: colors.brandSoft }, diagnosisIcon: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.brandSoft, alignItems: 'center', justifyContent: 'center' }, diagEyebrow: { color: colors.brand, fontSize: 9, fontWeight: '700' }, diagTitle: { color: colors.text, fontSize: 14, lineHeight: 20, fontWeight: '900', marginTop: 2 }, diagBody: { color: colors.muted, fontSize: 10, marginTop: 3 },
