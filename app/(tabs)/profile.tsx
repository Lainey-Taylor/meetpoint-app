...
const styles = StyleSheet.create({
  identity: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 3, paddingVertical: 5 }, nameRow: { flexDirection: 'row', alignItems: 'center', gap: 7 }, name: { color: colors.text, fontSize: 19, fontWeight: '900' }, owner: { color: '#385F88', fontSize: 9, backgroundColor: colors.brandSoft, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 7, overflow: 'hidden', fontWeight: '700' }, base: { color: colors.muted, fontSize: 11, marginTop: 5 },
