...
const styles = StyleSheet.create({
  ...
  membersCard: { gap: 14 }, member: { backgroundColor: colors.background, borderRadius: 15, padding: 13 }, memberGap: { marginTop: 0 }, memberTop: { flexDirection: 'row', alignItems: 'center', gap: 10 }, memberBadge: { width: 36, height: 36, borderRadius: 18, backgroundColor: colors.blue, alignItems: 'center', justifyContent: 'center' }, friendBadge: { backgroundColor: '#FFA000' }, memberBadgeText: { color: '#fff', fontWeight: '900' }, friendBadgeText: { color: '#fff' }, memberName: { color: colors.text, fontSize: 13, fontWeight: '900' }, memberNameInput: { color: colors.text, fontSize: 13, fontWeight: '900', padding: 0 }, memberAddressInput: { color: colors.muted, fontSize: 10, padding: 0, marginTop: 5 }, modeLimits: { flexDirection: 'row', marginTop: 13, gap: 5 }, modeLimit: { flex: 1, minWidth: 0, minHeight: 82, backgroundColor: '#fff', borderRadius: 10, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center', padding: 4 }, modeDisabled: { opacity: .52 }, modeToggle: { width: '100%', alignItems: 'center' }, modeEmoji: { fontSize: 18, lineHeight: 22 }, modeLabel: { color: colors.muted, fontSize: 8, marginTop: 3, textAlign: 'center' }, modeValue: { color: colors.text, fontSize: 9, fontWeight: '800', marginTop: 5 }, limitRow: { flexDirection: 'row', alignItems: 'center', marginTop: 3 }, limitInput: { width: 28, padding: 0, color: colors.brand, fontSize: 11, fontWeight: '900', textAlign: 'right' }, limitUnit: { color: colors.brand, fontSize: 9, marginLeft: 1 }, disabledText: { opacity: .38 },
