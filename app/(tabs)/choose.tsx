...
export default function ChooseScreen() {
  ...
  return (
    <Screen>
      ...
      <PrimaryButton label={loading ? '正在计算通勤时间…' : '查找大家都想去的餐厅'} icon="location.magnifyingglass" onPress={calculate} disabled={loading} />
...
const styles = StyleSheet.create({
  ...
  fieldLabel: { color: colors.muted, fontSize: 10, fontWeight: '700' }, modeWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, mode: { minHeight: 34, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 9, borderRadius: 11, backgroundColor: colors.subtle, borderWidth: 1, borderColor: colors.subtle }, modeActive: { backgroundColor: colors.brandSoft, borderColor: '#BFD2E5' }, modeText: { color: colors.muted, fontSize: 11, fontWeight: '600' }, modeTextActive: { color: colors.brand, fontWeight: '800' }, limit: { width: 30, padding: 0, marginLeft: 5, fontSize: 11, fontWeight: '800', color: colors.text, textAlign: 'right' }, minutes: { color: colors.muted, fontSize: 10, marginLeft: 2 },
  add: { minHeight: 47, borderRadius: 14, borderWidth: 1, borderStyle: 'dashed', borderColor: '#AFC5DA', backgroundColor: '#F7FAFD', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, addText: { color: colors.brand, fontSize: 12, fontWeight: '800' },
