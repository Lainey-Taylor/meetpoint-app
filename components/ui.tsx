...
const styles = StyleSheet.create({
  ...
  content: { paddingHorizontal: 16, paddingTop: 8, paddingBottom: 34, gap: 16 },
  header: { minHeight: 48, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  brandRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  logo: { width: 34, height: 34, borderRadius: 17, backgroundColor: colors.brand, alignItems: 'center', justifyContent: 'center' },
  brandTextRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  brand: { fontSize: 17, color: colors.text, fontWeight: '800', letterSpacing: -.3 },
  badge: { fontSize: 10, color: colors.brand, backgroundColor: colors.brandSoft, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 10, overflow: 'hidden', fontWeight: '700' },
  card: { backgroundColor: colors.card, borderRadius: 18, padding: 16, ...shadows.card },
  ...
  chip: { minHeight: 36, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 18, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.line, justifyContent: 'center' },
  chipText: { fontSize: 12, color: colors.muted, fontWeight: '600' },
  primary: { minHeight: 50, borderRadius: 25, backgroundColor: colors.brand, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, shadowColor: colors.brand, shadowOpacity: .18, shadowRadius: 13, shadowOffset: { width: 0, height: 6 }, elevation: 3 },
